package com.example.wallet.aop;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.example.wallet.controller..*(..)) || execution(* com.example.wallet.service..*(..)) || execution(* com.wallet.cart.repository..*(..))")
